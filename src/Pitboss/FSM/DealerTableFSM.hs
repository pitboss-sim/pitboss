...
module Pitboss.FSM.DealerTableFSM
  ( module Pitboss.FSM.DealerTableFSM.FSM,
    module Pitboss.FSM.DealerTableFSM.Phase,
    module Pitboss.FSM.DealerTableFSM.Transition,
    SomeDealerTableFSM (..),
...
import Pitboss.FSM.DealerTableFSM.Transition
