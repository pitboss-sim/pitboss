...
import Pitboss.Blackjack.Materia.Hand (SomeHand (..), HandKindWitness(..), characterize, handScore, witness, extractPairRank, unHand)
import Pitboss.Blackjack.Offering (Offering, ruleSet)
import Pitboss.Blackjack.Offering.RuleSet (RuleSet, DoubleRule(..), doubling, splitHands, SplitAcesAllowed(..), splitAcesAllowed, ResplitAcesAllowed(..), resplitAcesAllowed, canSplitAnotherHand)
