...
import Pitboss.Mechanics.Dealer.Types.DealerHandFSM
import Pitboss.Mechanics.Dealer.Types.DealerRoundFSM
import Pitboss.Mechanics.Dealer.Types.DealerTableFSM
...
data DealerStateChange
  = RenameDealer String
  | SetDealerTableFSM SomeDealerTableFSM
  | SetDealerRoundFSM SomeDealerRoundFSM
