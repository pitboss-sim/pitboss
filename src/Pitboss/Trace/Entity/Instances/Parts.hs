...
module Pitboss.Trace.Entity.Instances.Parts where
...
import Pitboss.Trace.Entity.Types.EntityId (ClockedRef)
...
type instance AttrsDelta 'Dealer = D.DealerEntityAttrsDelta
type instance ModesDelta 'Dealer = D.DealerEntityModesDelta
type instance RelsDelta 'Dealer = D.DealerEntityRelsDelta

type instance AttrsDelta 'DealerHand = DH.DealerHandEntityAttrsDelta
type instance ModesDelta 'DealerHand = DH.DealerHandEntityModesDelta
type instance RelsDelta 'DealerHand = DH.DealerHandEntityRelsDelta

type instance AttrsDelta 'DealerRound = DR.DealerRoundEntityAttrsDelta
type instance ModesDelta 'DealerRound = DR.DealerRoundEntityModesDelta
type instance RelsDelta 'DealerRound = DR.DealerRoundEntityRelsDelta

type instance AttrsDelta 'Player = P.PlayerEntityAttrsDelta
type instance ModesDelta 'Player = P.PlayerEntityModesDelta
type instance RelsDelta 'Player = P.PlayerEntityRelsDelta

type instance AttrsDelta 'PlayerHand = PH.PlayerHandEntityAttrsDelta
type instance ModesDelta 'PlayerHand = PH.PlayerHandEntityModesDelta
type instance RelsDelta 'PlayerHand = PH.PlayerHandEntityRelsDelta

type instance AttrsDelta 'PlayerSpot = PS.PlayerSpotEntityAttrsDelta
type instance ModesDelta 'PlayerSpot = PS.PlayerSpotEntityModesDelta
type instance RelsDelta 'PlayerSpot = PS.PlayerSpotEntityRelsDelta

type instance AttrsDelta 'Table = T.TableEntityAttrsDelta
type instance ModesDelta 'Table = T.TableEntityModesDelta
type instance RelsDelta 'Table = T.TableEntityRelsDelta

type instance AttrsDelta 'TableShoeCursor = TSC.TableShoeCursorEntityAttrsDelta
type instance ModesDelta 'TableShoeCursor = TSC.TableShoeCursorEntityModesDelta
type instance RelsDelta 'TableShoeCursor = TSC.TableShoeCursorEntityRelsDelta

type instance AttrsDelta 'Offering = O.OfferingEntityAttrsDelta
type instance ModesDelta 'Offering = O.OfferingEntityModesDelta
type instance RelsDelta 'Offering = O.OfferingEntityRelsDelta
...
-- Updated implementation: per-k Incremental instances for Delta k
...
instance Incremental (Delta 'TableShoeCursor) where
    type Target (Delta 'TableShoeCursor) = Entity 'TableShoeCursor
...
-- Note: Delta 'TableShoe is static / Noop only
...
class HasEntityParts (k :: EntityKind) where
    type Attrs k
    type Modes k
    type Rels k
    type IdOf k
...
class ReplaceEntityParts (k :: EntityKind) where
    replaceAttrs :: Entity k -> Attrs k -> Entity k
    replaceModes :: Entity k -> Modes k -> Entity k
    replaceRels :: Entity k -> Rels k -> Entity k

instance HasEntityParts 'Dealer where
    type Attrs 'Dealer = DealerEntityAttrs
    type Modes 'Dealer = DealerEntityModes
    type Rels 'Dealer = DealerEntityRels
    type IdOf 'Dealer = DealerEntityId
...
instance ReplaceEntityParts 'Dealer where
...
instance HasEntityParts 'DealerHand where
    type Attrs 'DealerHand = DealerHandEntityAttrs
    type Modes 'DealerHand = DealerHandEntityModes
    type Rels 'DealerHand = DealerHandEntityRels
    type IdOf 'DealerHand = DealerHandEntityId
...
instance ReplaceEntityParts 'DealerHand where
...
instance HasEntityParts 'DealerRound where
    type Attrs 'DealerRound = DealerRoundEntityAttrs
    type Modes 'DealerRound = DealerRoundEntityModes
    type Rels 'DealerRound = DealerRoundEntityRels
    type IdOf 'DealerRound = DealerRoundEntityId
...
instance ReplaceEntityParts 'DealerRound where
...
instance HasEntityParts 'Offering where
    type Attrs 'Offering = OfferingEntityAttrs
    type Modes 'Offering = OfferingEntityModes
    type Rels 'Offering = OfferingEntityRels
    type IdOf 'Offering = OfferingEntityId
...
instance ReplaceEntityParts 'Offering where
...
instance HasEntityParts 'Player where
    type Attrs 'Player = PlayerEntityAttrs
    type Modes 'Player = PlayerEntityModes
    type Rels 'Player = PlayerEntityRels
    type IdOf 'Player = PlayerEntityId
...
instance ReplaceEntityParts 'Player where
...
instance HasEntityParts 'PlayerHand where
    type Attrs 'PlayerHand = PlayerHandEntityAttrs
    type Modes 'PlayerHand = PlayerHandEntityModes
    type Rels 'PlayerHand = PlayerHandEntityRels
    type IdOf 'PlayerHand = PlayerHandEntityId
...
instance ReplaceEntityParts 'PlayerHand where
...
instance HasEntityParts 'PlayerSpot where
    type Attrs 'PlayerSpot = PlayerSpotEntityAttrs
    type Modes 'PlayerSpot = PlayerSpotEntityModes
    type Rels 'PlayerSpot = PlayerSpotEntityRels
    type IdOf 'PlayerSpot = PlayerSpotEntityId
...
instance ReplaceEntityParts 'PlayerSpot where
...
instance HasEntityParts 'Table where
    type Attrs 'Table = TableEntityAttrs
    type Modes 'Table = TableEntityModes
    type Rels 'Table = TableEntityRels
    type IdOf 'Table = TableEntityId
...
instance ReplaceEntityParts 'Table where
...
instance HasEntityParts 'TableShoe where
    type Attrs 'TableShoe = TableShoeEntityAttrs
    type Modes 'TableShoe = TableShoeEntityModes
    type Rels 'TableShoe = TableShoeEntityRels
    type IdOf 'TableShoe = TableShoeEntityId
...
instance ReplaceEntityParts 'TableShoe where
...
instance HasEntityParts 'TableShoeCursor where
    type Attrs 'TableShoeCursor = TableShoeCursorEntityAttrs
    type Modes 'TableShoeCursor = TableShoeCursorEntityModes
    type Rels 'TableShoeCursor = TableShoeCursorEntityRels
    type IdOf 'TableShoeCursor = TableShoeCursorEntityId
...
instance ReplaceEntityParts 'TableShoeCursor where
