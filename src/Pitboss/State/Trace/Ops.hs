...
-- Registry access using type applications
...
-- Main trace operation application using witness dispatch
...
-- Helper constructors using HasWitness to extract witness
