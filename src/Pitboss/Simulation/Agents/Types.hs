...
data BoutContext = BoutContext
    { _contextContestantHand :: SomeHand
...
instance (Generic (ArchetypeConfig k), GToJSON Zero (Rep (ArchetypeConfig k))) => ToJSON (ArchetypeConfig k) where
    toJSON = genericToJSON defaultOptions
instance (Generic (ArchetypeConfig k), GFromJSON Zero (Rep (ArchetypeConfig k))) => FromJSON (ArchetypeConfig k) where
    parseJSON = genericParseJSON defaultOptions

instance (Generic (ArchetypeState k), GToJSON Zero (Rep (ArchetypeState k))) => ToJSON (ArchetypeState k) where
    toJSON = genericToJSON defaultOptions
instance (Generic (ArchetypeState k), GFromJSON Zero (Rep (ArchetypeState k))) => FromJSON (ArchetypeState k) where
    parseJSON = genericParseJSON defaultOptions

instance (Generic (DealerArchetypeConfig k), GToJSON Zero (Rep (DealerArchetypeConfig k))) => ToJSON (DealerArchetypeConfig k) where
    toJSON = genericToJSON defaultOptions
instance (Generic (DealerArchetypeConfig k), GFromJSON Zero (Rep (DealerArchetypeConfig k))) => FromJSON (DealerArchetypeConfig k) where
    parseJSON = genericParseJSON defaultOptions

instance (Generic (DealerArchetypeState k), GToJSON Zero (Rep (DealerArchetypeState k))) => ToJSON (DealerArchetypeState k) where
    toJSON = genericToJSON defaultOptions
instance (Generic (DealerArchetypeState k), GFromJSON Zero (Rep (DealerArchetypeState k))) => FromJSON (DealerArchetypeState k) where
    parseJSON = genericParseJSON defaultOptions
