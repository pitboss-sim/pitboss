...
module Pitboss.FSM.DealerHandFSM
  ( module Pitboss.FSM.DealerHandFSM.FSM,
    module Pitboss.FSM.DealerHandFSM.Phase,
    module Pitboss.FSM.DealerHandFSM.Transition,
    SomeDealerHandFSM (..),
...
import Pitboss.FSM.DealerHandFSM.Transition
